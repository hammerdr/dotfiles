...
my_git_formatter () {
	...
	[[ -z $VCS_STATUS_LOCAL_BRANCH && -z $VCS_STATUS_LOCAL_BRANCH ]] && res+="${meta}@${clean}${VCS_STATUS_COMMIT[1,8]}" 
...
if ! command -v rg >/dev/null 2>&1; then
  alias rg='/usr/local/Cellar/ripgrep/14.1.1/bin/rg'
fi
export PATH=/opt/homebrew/bin\:/opt/homebrew/sbin\:/usr/local/bin\:/System/Cryptexes/App/usr/bin\:/usr/bin\:/bin\:/usr/sbin\:/sbin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/local/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/appleinternal/bin\:/Applications/iTerm.app/Contents/Resources/utilities\:/Users/derek/nvim/bin\:/Users/derek/.cargo/bin
